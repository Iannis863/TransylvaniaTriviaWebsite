...
export const SEASON_1_SCHEDULE: Omit<ScheduleEdition, "id">[] = [
  ...
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 2, monthName: "Octombrie", dayOfMonth: 13, monthIndex: 9, yearOffset: 0, theme: "Cinema Cult & Seriale Horror", description: "Capodopere cinematografice, regizori vizionari și scene de neuitat.", secretClue: "Indiciu Secret: Primul film cu vampiri a apărut în 1922 (Nosferatu).", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 3, monthName: "Octombrie", dayOfMonth: 20, monthIndex: 9, yearOffset: 0, theme: "Muzica Anilor '80 & '90", description: "Hituri nemuritoare, versuri de continuat și ritmuri nostalgice.", secretClue: "Indiciu Secret: Thriller de Michael Jackson a fost lansat în 1982.", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 4, monthName: "Octombrie", dayOfMonth: 27, monthIndex: 9, yearOffset: 0, theme: "Ediție Specială: Noaptea de Halloween", description: "Costume, mistere oculte, castele bântuite și miză dublă!", secretClue: "Indiciu Secret: Castelul Bran a fost donat Reginei Maria în 1920.", maxTeams: 30 },
  // Noiembrie (4 editions)
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 5, monthName: "Noiembrie", dayOfMonth: 3, monthIndex: 10, yearOffset: 0, theme: "Știință, Univers & Tehnologie", description: "De la astronomie la inteligență artificială și explorare spațială.", secretClue: "Indiciu Secret: Lumina de la Soare ajunge pe Pământ în ~8 minute și 20 de secunde.", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 6, monthName: "Noiembrie", dayOfMonth: 10, monthIndex: 10, yearOffset: 0, theme: "Geografia Lumii & Marile Capitale", description: "Munți uriași, oceane adânci și recorduri geografice uimitoare.", secretClue: "Indiciu Secret: Singura țară din lume fără capitală oficială este Nauru.", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 7, monthName: "Noiembrie", dayOfMonth: 17, monthIndex: 10, yearOffset: 0, theme: "Gamer's Vault: Jocuri Video & Pop Culture", description: "Lumi virtuale, eroi pixelati și benzi desenate iconice.", secretClue: "Indiciu Secret: Personajul Mario a purtat inițial numele Jumpman.", maxTeams: 25 },
  ...
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 9, monthName: "Decembrie", dayOfMonth: 1, monthIndex: 11, yearOffset: 0, theme: "Ediție de Ziua Națională: Istoria României", description: "Voievozi, tratate istorice, invenții românești și cultură autentică.", secretClue: "Indiciu Secret: Henri Coandă a brevetat motorul cu reacție în 1910.", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 10, monthName: "Decembrie", dayOfMonth: 8, monthIndex: 11, yearOffset: 0, theme: "Gastronomie Mondială & Licori Magice", description: "Rețete secrete, tradiții culinare globale și băuturi legendare.", secretClue: "Indiciu Secret: Șofranul este cel mai scump condiment din lume după greutate.", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 11, monthName: "Decembrie", dayOfMonth: 15, monthIndex: 11, yearOffset: 0, theme: "Gala de Crăciun & Marele Jackpot de Iarnă", description: "Sărbătoare, tombolă cu premii uriașe și atmosferă de poveste.", secretClue: "Indiciu Secret: Punctajul la Final Gamble poate răsturna clasamentul general!", maxTeams: 30 },
  // Ianuarie (4 editions)
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 12, monthName: "Ianuarie", dayOfMonth: 5, monthIndex: 0, yearOffset: 1, theme: "Restart de An Nou: Recorduri Mondiale", description: "Performanțe incredibile, curiozități bizare și statistici șocante.", secretClue: "Indiciu Secret: Cel mai adânc punct de pe Pământ este Groapa Marianelor (~11.000m).", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 13, monthName: "Ianuarie", dayOfMonth: 12, monthIndex: 0, yearOffset: 1, theme: "Anii 2000 & Nostalgia Copilăriei", description: "Desene animate Cartoon Network, primele telefoane mobile și hituri pop.", secretClue: "Indiciu Secret: Primul iPhone a fost dezvăluit de Steve Jobs în ianuarie 2007.", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 14, monthName: "Ianuarie", dayOfMonth: 19, monthIndex: 0, yearOffset: 1, theme: "Arhitectură, Artă & Capodopere", description: "Renașterea, sculptori celebri, muzee celebre și monumente impunătoare.", secretClue: "Indiciu Secret: Capela Sixtină a fost pictată de Michelangelo între 1508 și 1512.", maxTeams: 25 },
  { seasonNumber: 1, seasonName: "Sezonul 1 (Toamnă - Iarnă)", editionNumber: 15, monthName: "Ianuarie", dayOfMonth: 26, monthIndex: 0, yearOffset: 1, theme: "Marea Finală a Sezonului 1: Încoronarea Campionilor", description: "Ultima bătălie a sezonului cu trofeul suprem și premii speciale!", secretClue: "Indiciu Secret: Câștigătorii primesc acces direct în Liga Campionilor Trivia!", maxTeams: 30 },
];
...
export const SEASON_2_SCHEDULE: Omit<ScheduleEdition, "id">[] = [
  ...
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 1, monthName: "Februarie", dayOfMonth: 2, monthIndex: 1, yearOffset: 1, theme: "Start Sezonul 2: Noua Provocare", description: "Echipe noi, rivalități renăscute și întrebări proaspete.", secretClue: "Indiciu Secret: Februarie a fost adăugată în calendarul roman de Numa Pompilius.", maxTeams: 25 },
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 2, monthName: "Februarie", dayOfMonth: 9, monthIndex: 1, yearOffset: 1, theme: "Cinematografia Europeană & Premiile Oscar", description: "Filme premiate, actori legendari și coloane sonore celebre.", secretClue: "Indiciu Secret: Statueta Oscar este placată cu aur de 24 de carate.", maxTeams: 25 },
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 3, monthName: "Februarie", dayOfMonth: 16, monthIndex: 1, yearOffset: 1, theme: "Dragoste, Pasiune & Tragedii Istorice", description: "Cupluri celebre din istorie, literatură și mitologie.", secretClue: "Indiciu Secret: Povestea lui Romeo și Julieta a fost inspirată dintr-o legendă italiană mai veche.", maxTeams: 25 },
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 4, monthName: "Februarie", dayOfMonth: 23, monthIndex: 1, yearOffset: 1, theme: "Băuturi Fine, Vinuri & Istoria Berii", description: "Curiozități despre fabricarea berii, regiuni viticole și cocktailuri.", secretClue: "Indiciu Secret: Cea mai veche berărie din lume funcționează continuu din anul 1040 (Weihenstephan).", maxTeams: 25 },
  // Martie (4 editions)
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 5, monthName: "Martie", dayOfMonth: 2, monthIndex: 2, yearOffset: 1, theme: "Mărțișor & Femei Excepționale din Istorie", description: "Pioniere ale științei, regine puternice și artiste geniale.", secretClue: "Indiciu Secret: Marie Curie este singura persoană cu premii Nobel în două științe diferite.", maxTeams: 25 },
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 6, monthName: "Martie", dayOfMonth: 9, monthIndex: 2, yearOffset: 1, theme: "Rock Legends & Festivaluri Mondiale", description: "Solo-uri celebre, trupe legendare și istoria festivalurilor rock.", secretClue: "Indiciu Secret: Festivalul Woodstock original a avut loc în august 1969.", maxTeams: 25 },
  ...
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 11, monthName: "Aprilie", dayOfMonth: 20, monthIndex: 3, yearOffset: 1, theme: "Universul Sci-Fi: Star Wars, Dune & Matrix", description: "Galaxii îndepărtate, roboți conștienți și viitoruri distopice.", secretClue: "Indiciu Secret: Limba Klingoniană are o gramatică completă creată de un lingvist.", maxTeams: 25 },
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 12, monthName: "Aprilie", dayOfMonth: 27, monthIndex: 3, yearOffset: 1, theme: "Comedii Clasice, Sitcom-uri & Stand-up", description: "Friends, Seinfeld, The Office și glume nemuritoare.", secretClue: "Indiciu Secret: Celebrul duel cu 'Pivot!' din Friends a fost improvizat parțial.", maxTeams: 25 },
  // Mai (3 editions)
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 13, monthName: "Mai", dayOfMonth: 11, monthIndex: 4, yearOffset: 1, theme: "Călătorii Globale & Trasee Legendare", description: "Drumul Mătăsii, Orient Express și exploratori curajoși.", secretClue: "Indiciu Secret: Marco Polo a petrecut 24 de ani călătorind în Asia.", maxTeams: 25 },
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 14, monthName: "Mai", dayOfMonth: 18, monthIndex: 4, yearOffset: 1, theme: "Semifinala Sezonului 2: Presiunea Maximă", description: "Penultima rundă înaintea finalei mari - bătălia pentru podium.", secretClue: "Indiciu Secret: Fiecare punct obținut în Joker poate asigura calificarea!", maxTeams: 25 },
  { seasonNumber: 2, seasonName: "Sezonul 2 (Primăvară)", editionNumber: 15, monthName: "Mai", dayOfMonth: 25, monthIndex: 4, yearOffset: 1, theme: "Marea Finală a Sezonului 2 & Trofeul Absolut", description: "Spectacol total, festivitatea de premiere și încheierea glorioasă a sezonului.", secretClue: "Indiciu Secret: Campionii Sezonului 2 intră în Galeria Gloriei Transilvania Trivia!", maxTeams: 35 },
];
...
export function getCurrentOrNextEdition(now: Date = new Date()): ActiveEditionState {
  ...
  const formattedTime = "20:00 (Ora României)";
